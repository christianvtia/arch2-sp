        ...
        <div className="flex flex-col bg-white h-3/4 w-3/4 text-xl shadow-md py-8 px-40">
          ...
          <div className='flex flex-col my-4'>
            ...
            <div className="w-full justify-between flex flex-row">
              <div>
                <p className="text-sm">This translator does not account for error due to conversion.</p>
              </div>
              <div className='w-fit self-end flex cursor-pointer' onClick={copyToClipboard}>
